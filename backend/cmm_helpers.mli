...
val unaligned_load_256 : expression -> expression -> Debuginfo.t -> expression

val unaligned_set_256 :
  expression -> expression -> expression -> Debuginfo.t -> expression

val aligned_load_256 : expression -> expression -> Debuginfo.t -> expression

val aligned_set_256 :
  expression -> expression -> expression -> Debuginfo.t -> expression

val unaligned_load_512 : expression -> expression -> Debuginfo.t -> expression

val unaligned_set_512 :
  expression -> expression -> expression -> Debuginfo.t -> expression

val aligned_load_512 : expression -> expression -> Debuginfo.t -> expression
