...
type float_width = Float_helpers.float_width =
  | Float64
  | Float32
...
let iter_shallow_tail f = function
  ...
  | Cconst_vec128 _ | Cconst_vec256 _ | Cconst_vec512 _ | Cconst_symbol _ | Cvar _ | Ctuple _
  | Cop
...
let iter_shallow f = function
  ...
  | Cconst_int _ | Cconst_natint _ | Cconst_float32 _ | Cconst_float _
  | Cconst_vec128 _ | Cconst_vec256 _ | Cconst_vec512 _ | Cconst_symbol _ | Cvar _ ->
    ()
...
let map_shallow f = function
  ...
  | ( Cconst_int _ | Cconst_natint _ | Cconst_float32 _ | Cconst_float _
    | Cconst_vec128 _ | Cconst_vec256 _ | Cconst_vec512 _ | Cconst_symbol _ | Cvar _ ) as c ->
    c
...
let equal_static_cast (left : static_cast) (right : static_cast) =
  ...
  | ( ( Float32_of_float | Float_of_float32 | Float_of_int _ | Int_of_float _
      ...
      | Scalar_of_v256 _ | V256_of_scalar _
