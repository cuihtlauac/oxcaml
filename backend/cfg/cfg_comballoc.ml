 ...
 fun cell ->
  ...
  | Some cell -> (
    ...
    | Op
        ...
        | Const_symbol _ | Const_vec128 _ | Const_vec256 _ | Const_vec512 _ | Stackoffset _ | Load _ | Store _
  ...
  let rec loop (allocations : allocation list) (cell : cell option)
    ...
    | Some cell -> (
      ...
      | Op
          ...
          | Const_int _ | Const_float _ | Const_float32 _ | Const_vec128 _ | Const_vec256 _ | Const_vec512 _
