...
let rec subkind (k : Flambda_kind.With_subkind.Non_null_value_subkind.t) :
  ...
  | Unboxed_nativeint_array | Unboxed_vec128_array | Unboxed_vec256_array | Unboxed_vec512_array | Unboxed_product_array ->
    Misc.fatal_error
      "fexpr support for unboxed float32/int32/64/nativeint/vec128/vec256/vec512/unboxed \
...
let fexpr_of_array_kind : Flambda_primitive.Array_kind.t -> Fexpr.array_kind =
  ...
  | Naked_vec128s | Naked_vec256s | Naked_vec512s | Unboxed_product _ ->
    Misc.fatal_error
      "fexpr support for unboxed float32/int32/64/nativeint/vec128/vec256/vec512/unboxed product \
...
let fexpr_of_array_set_kind env
  ...
  | Naked_vec128s | Naked_vec256s | Naked_vec512s ->
    Misc.fatal_error
      "fexpr support for unboxed float32/int32/64/nativeint/vec128/vec256/vec512 arrays not \
       yet implemented"
