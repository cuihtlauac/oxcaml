...
and type_unboxed_int8x32 = newgenty (Tconstr(path_unboxed_int8x32, [], ref Mnil))
and type_unboxed_int16x16 = newgenty (Tconstr(path_unboxed_int16x16, [], ref Mnil))
and type_unboxed_int32x8 = newgenty (Tconstr(path_unboxed_int32x8, [], ref Mnil))
and type_unboxed_int64x4 = newgenty (Tconstr(path_unboxed_int64x4, [], ref Mnil))
and type_unboxed_float32x8 = newgenty (Tconstr(path_unboxed_float32x8, [], ref Mnil))
and type_unboxed_float64x4 = newgenty (Tconstr(path_unboxed_float64x4, [], ref Mnil))
and type_unboxed_int8x64 = newgenty (Tconstr(path_unboxed_int8x64, [], ref Mnil))
and type_unboxed_int16x32 = newgenty (Tconstr(path_unboxed_int16x32, [], ref Mnil))
and type_unboxed_int32x16 = newgenty (Tconstr(path_unboxed_int32x16, [], ref Mnil))
and type_unboxed_int64x8 = newgenty (Tconstr(path_unboxed_int64x8, [], ref Mnil))
and type_unboxed_float32x16 = newgenty (Tconstr(path_unboxed_float32x16, [], ref Mnil))
and type_unboxed_float64x8 = newgenty (Tconstr(path_unboxed_float64x8, [], ref Mnil))
...
let mk_add_extension add_extension id args =
  List.iter (fun (_, sort) ->
      ...
      | Base Value -> ()
      | Base (Void | Float32 | Float64 | Word | Bits32 | Bits64 | Vec128 | Vec256 | Vec512)
