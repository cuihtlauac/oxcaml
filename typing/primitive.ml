...
let equal_unboxed_vector ((Unboxed_vec128 | Unboxed_vec256 | Unboxed_vec512) as v1) v2 = v1 = v2
let compare_unboxed_vector ((Unboxed_vec128 | Unboxed_vec256 | Unboxed_vec512) as v1) v2 = Stdlib.compare v1 v2
